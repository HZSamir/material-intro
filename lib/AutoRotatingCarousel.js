...
var _arrowIconButtonLeft, _arrowIconButtonRight;
...
var desktopStyles = {
  ...
  arrowIconButtonLeft: (_arrowIconButtonLeft = {
    width: 48,
    height: 48,
    position: 'absolute',
    top: 'calc((100% - 96px) / 2 + 24px)',
    left: -96
  }, _defineProperty(_arrowIconButtonLeft, 'width', 48), _defineProperty(_arrowIconButtonLeft, 'height', 48), _defineProperty(_arrowIconButtonLeft, 'padding', 4), _arrowIconButtonLeft),
  arrowIconButtonRight: (_arrowIconButtonRight = {
    width: 48,
    height: 48,
    position: 'absolute',
    top: 'calc((100% - 96px) / 2 + 24px)',
    right: -96
  }, _defineProperty(_arrowIconButtonRight, 'width', 48), _defineProperty(_arrowIconButtonRight, 'height', 48), _defineProperty(_arrowIconButtonRight, 'padding', 4), _arrowIconButtonRight),
  arrowIcon: {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { style: landscape ? { minWidth: 400, maxWidth: 'calc(50% - 48px)', padding: 24, float: 'right' } : null },
            _react2.default.createElement(
              'div',
          ...
          !this.props.mobile && !this.props.hideArrows ? _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
